  ...
  return (
    <div className="bg-white border-b">
      <div className="container relative flex flex-row items-center justify-between py-4 mx-auto bg-white">
        <div className="flex">
          <h2 className="text-base font-semibold uppercase select-none">Drawer configurator</h2>
        </div>
        ...
        <div className="z-10 flex">
          {inProjectPage && (
            <div className="flex items-center cursor-pointer">
              ...
              <button className="relative mx-4" onClick={() => context.setUnit(context.unit === 'mm' ? 'in' : 'mm')}>
                ...
                <div
                  className={classNames(
                    'absolute left-1 top-1 bg-primary w-6 h-6 rounded-full transition transform',
          ...
          {goBack ? (
            <Link href="/" passHref>
              <XCircleSolid className="cursor-pointer w-9 h-9 text-primary" />
            </Link>
          ) : (
